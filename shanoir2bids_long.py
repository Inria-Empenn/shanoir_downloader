...
# @Author: Malo Gaubert <malo.gaubert@irisa.fr>, Quentin Duche <quentin.duche@irisa.fr>
# @Date: 24 Juin 2022
import os
import sys
import zipfile
...
class DownloadShanoirDatasetToBIDS:
    ...
    def download_subject(self, subject_to_search):
        ...
        for seq in range(self.n_seq):
            ...
            if not bids_seq_session.startswith('ses-'):
                bids_seq_session = 'ses-' + bids_seq_session
            ...
            search_txt = 'studyName:' + self.shanoir_study_id.replace(" ", "?")+ ' AND datasetName:' + shanoir_seq_name.replace(" ", "?")  + \
                        ...
                        ' AND examinationDate:[' + self.date_from + ' TO ' + self.date_to + ']'
                         ...
                         #examinationDate:[2014-03-21T00:00:00Z TO 2014-03-22T00:00:00Z]
