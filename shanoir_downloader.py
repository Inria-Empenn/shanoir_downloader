...
def add_ids_arguments(parser):
    parser.add_argument('-dt', '--dataset_id', default='', help='The dataset id to download.')
    parser.add_argument('-dts', '--dataset_ids', default='', help='Path to a file containing the dataset ids to download (a .txt file containing one dataset id per line).')
    parser.add_argument('-st', '--study_id', default='', help='The study id to download.')
    parser.add_argument('-sb', '--subject_id', default='', help='The subject id to download.')
    return
