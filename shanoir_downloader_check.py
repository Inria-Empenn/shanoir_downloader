...
def add_downloaded_dataset(downloaded_datasets, missing_datasets, sequence_id, patient_name_in_dicom, series_description_in_dicom, verified):
	...
	downloaded_datasets.loc[sequence_id, 'series_description_match'] = series_description_in_dicom == downloaded_datasets.at[sequence_id, 'series_description']
...
while len(datasets_to_download) > 0:
	...
	for index, row in datasets_to_download.iterrows():
		...
		try:
			...
			if series_description_in_dicom != series_description: 	# or if ds[0x0008, 0x103E].value != series_description:
		...
		downloaded_datasets = add_downloaded_dataset(downloaded_datasets, missing_datasets, sequence_id, patient_name_in_dicom, series_description_in_dicom, verified)