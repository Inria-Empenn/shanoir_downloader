...
parser.add_argument('-dti', '--datasets_to_ignore', default=None, help='Path to a tsv file containing the datasets to ignore (the file could be the missing_datasets file generated by this script). Datasets listed in this file will not be downloaded.')
...
datasets_to_ignore = pandas.read_csv(args.datasets_to_ignore, sep=',' if args.datasets_to_ignore.endswith('.csv') else '\t', dtype=datasets_dtype)
# Drop datasets to ignore
all_datasets = all_datasets[~all_datasets.index.isin(datasets_to_ignore.sequence_id)]
