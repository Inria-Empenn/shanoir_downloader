...
parser.add_argument('-dids', '--downloaded_datasets', default=None, help='Path to a tsv file containing the already downloaded datasets (generated by this script). Creates the file "downloaded_datasets.tsv" in the given output_folder by default.')
parser.add_argument('-mids', '--missing_datasets', default=None, help='Path to a tsv file containing the missing datasets (generated by this script). Creates the file "missings_datasets.tsv" in the given output_folder by default.')
parser.add_argument('-af', '--anonymization_fields', default='anonymization_fields.tsv', help='Path to a tsv file containing the fields to overwrite.')
...
if not Path(args.anonymization_fields).exists():
	sys.exit(f'The file {args.anonymization_fields} does not exist. Please provide a valid anonymization_fields file.')

anonymization_fields = pandas.read_csv(args.anonymization_fields, sep='\t')
